...
export const metadata: Metadata = {
  ...
  description: "Red team operations, original security tools, threat simulation and public security research by Moaaz Taha.",
  ...
  openGraph: {
    ...
    locale: "en_GB",
    title: "Moaaz Taha — Red Team Operator and Security Researcher",
    description: "Red team work, original security tools and selected research by Moaaz Taha.",
